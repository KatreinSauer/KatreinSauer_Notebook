...
### Determine peak center, peak width, FWHM, amplitude (=height), area under the peak
**1) open a workbook (talbe) where you enter x and y values of only the peak you want to analyse. An entire spectrum is also possible, however, we want it easy.** \
 &#8594; click into that window \
 &#8594; click analysis (im Reiter oben) \
 &#8594; Peak and baseline\
 &#8594; Peak aanalyse\
 &#8594; find peaks  &#8594; enable auto find &#8594; find\
 &#8594; fit peaks (pro) &#8594; fit control &#8594; change Gauss to Voigt (or whatever you desire) &#8594;press the "iteration" button as often as it lets you iterate &#8594; okay \
 &#8594; finish \
 The results are in the table now.
